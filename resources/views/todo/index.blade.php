...
@section('content')
	...
	<div class="modal fade todo-edit-form-modal-lg" tabindex="-1" role="dialog" aria-labelledby="Edit your todo." id="edit-modal">
	  <div class="modal-dialog modal-md" role="document">
	    <div class="modal-content">
	      <div class="modal-header"><h3 class="text-center">Edit Todo</h3></div>
	      <div class="modal-body">
	      	<div class="row">
	      		<div class="col-sm-8 col-sm-offset-2">
...
@section('custom-js')
	<script type="text/javascript">
		$(document).ready(function(){
			$('[id^="editTodo-"').click(function(e){
				var targetCardId = $(this).data('target-id');
